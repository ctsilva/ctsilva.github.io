...
## Bad vs. Good: Twitter Users

::: {.columns}
::: {.column width="50%"}
### ❌ BAD: Raw Counts

![Number of Twitter Users (just a population map)](figs/week8/twitter-raw-counts.png){fig-align="center"}

**This shows:** Where people live

**This tells you:** Nothing about Twitter usage
:::

::: {.column width="50%"}
### ✓ GOOD: Normalized

![Percentage of Population on Twitter](figs/week8/twitter-percentage.png){fig-align="center"}

**This shows:** Twitter adoption rates

**This tells you:** A meaningful story about usage patterns
:::
:::

::: {.r-fit-text .fragment}
**If you put raw counts on a choropleth, you are lying.**
:::

::: {.notes}
This is the *single biggest mistake* people make. Look at the map on the left: "Number of Twitter Users." What does it show? It just shows where people live—California, Texas, New York. It's a population map. It tells you *nothing* about Twitter usage. The map on the right is normalized. It shows "Percentage of Population on Twitter." This is a *useful* map, and it tells a completely different story.
:::
