...
:::: {.columns}
::: {.column width="60%"}
![The fundamental question: How do I visualize this data?](figs/data-viz-pipeline.png){width="100%"}
:::
::: {.column width="40%"}
...
:::
::: {.column width="50%"}
![Example: Data types to visual mappings](figs/flight-data-domain-questions.png){width="100%"}
:::
::::
...
:::
::: {.column width="50%"}
![Bar chart ordering suggests ranking where none exists](figs/categorical-arbitrary-sorting.png){width="90%"}
...
**Channels:** Ways to vary marks
- Position, size, shape, color, orientation, texture
...
:::
::: {.column width="40%"}
**Key insight:** Different channels have different perceptual effectiveness for different data types
:::
::::

::: {.notes}
This is the foundation of systematic visualization design. Understanding marks and channels helps you make principled encoding decisions rather than arbitrary ones.
:::
...
:::: {.columns}
::: {.column width="50%"}
![Linear Scale Example](figs/linear-scale-example.jpg){width="90%"}
...
::: {.column width="50%"}
![Log Scale Example](figs/log-scale-example.jpg){width="90%"}
...
**For next class:**
- Read Tufte Chapter 1-2 (Graphical Excellence & Integrity)
- Practice chart selection with your own datasets
- Complete Exercise 3: Chart design and encoding alternatives
...
- Advanced visual encodings and multi-dimensional data
- Design critique and evaluation methods
