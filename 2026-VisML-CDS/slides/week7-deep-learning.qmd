...
:::: {.columns}
::: {.column width="60%"}
![](figs/UDLChap3PDF/ShallowBuildUp.jpg){fig-align="center" width="100%"}
:::
::: {.column width="40%"}
**Process:**
...
:::: {.columns}
::: {.column width="55%"}
![](figs/UDLChap4PDF/DeepConcat.jpg){fig-align="center" width="100%"}
:::
::: {.column width="45%"}
**Each layer:**
