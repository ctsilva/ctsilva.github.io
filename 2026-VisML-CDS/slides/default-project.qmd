...
::: {.column width="50%"}
![](figs/default-project/tile2net-example.jpg){width="100%" fig-align="center"}
:::
::::
...
### 1. Project Proposal (Due Oct 20)
- **Length**: 4 pages
- **Content**: Chosen direction, research questions, datasets, timeline

### 2. Final Report (Due Dec 14)
- **Length**: 8 pages (conference paper format, e.g., IEEE VIS)
