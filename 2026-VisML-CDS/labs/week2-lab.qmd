---
title: "Week 2 Lab: Introduction to Observable and Vega-Lite"
subtitle: "DS-GA 3001 - Visualization for Machine Learning"
author: "Bhavya Matam"
...
## Welcome to VisML Lab Session!

### Hands-on Visualization for Machine Learning

We'll start with Vega-Lite fundamentals that will be essential for ML visualizations later in the course.

## Week 2 Lab Overview

|User Interface|Graphics Library|Purpose|
|:--|:--|:--|
|[observablehq.com](https://observablehq.com)|[Vega-Lite](https://vega.github.io/vega-lite/)|Foundation for ML data visualization|
...
2. )
3. Scroll to the top-right of the notebook. You should see some function buttons, such as "Share" and "Fork this notebook".
4. Select "Fork this notebook", and save it into as your own **Observable** notebook.
...
- Session leader: Bhavya Matam (bm3792@nyu.edu); office hours TBD
