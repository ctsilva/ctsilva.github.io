...
- Getting Help
  - Course Discord channel - make sure to sign up via the QR code below!
...
![[Direct Link to Form](https://forms.gle/cxB9gcuTsxZbotby9)](./week1-lab_files/imgs/discord_signup.png){style="max-width:500px; width:100%;"}
