---
title: "CS-GY 6313 B: Information Visualization – Fall 2026 Syllabus"
permalink: /2026-InfoVis-CSE/syllabus
author_profile: true
---

[← Back to Course Home](/2026-InfoVis-CSE/) | [Detailed Schedule](/2026-InfoVis-CSE/schedule) | [Resources](/2026-InfoVis-CSE/resources)
...
# CS-GY 6313 B: Information Visualization – Fall 2026
...
- Fall Break (October 12) falls on a Monday and does not affect this course
- Deadline to withdraw from classes and to request the pass/fail option: November 25
- Thanksgiving Recess: November 26-27 (no class November 27)
- Last class: December 11
- Reading Day: December 15 - no classes or required meetings
...
*For detailed lecture content, readings, lab activities, and assignments, see: [Detailed Schedule](/2026-InfoVis-CSE/schedule)*
...
**Learning Objectives:** Identify misleading visualizations; understand ethical design principles; form project teams

### **Week 7** (Oct 16) - Interaction in Visualization
**Learning Objectives:** Design effective interactions; implement brushing, linking, and dynamic queries
...
**Learning Objectives:** Design visual query models for large spatio-temporal urban data
...
**Learning Objectives:** Design effective time series visualizations; understand cyclic and hierarchical time structures

### **Week 12** (Nov 20) - Clustering and Dimensionality Reduction
**Learning Objectives:** Visualize high-dimensional data; interpret PCA, t-SNE, and UMAP projections critically

### **Thanksgiving Recess** (Nov 26-27) - **NO CLASS**

### **Week 13** (Dec 4) - Visualizing Network Data
**Learning Objectives:** Understand network visualization techniques; apply tree and graph layouts

### **Week 14** (Dec 11) - Final Project Presentations
**Learning Objectives:** Present and critique visualization projects; reflect on learning
