---
title: "CS-GY 6313 B: Information Visualization - Fall 2026"
permalink: /2026-InfoVis-CSE/
author_profile: true
---
...
[Course Syllabus](/2026-InfoVis-CSE/syllabus) | [Detailed Schedule](/2026-InfoVis-CSE/schedule) | [Resources](/2026-InfoVis-CSE/resources)

## Announcements

**Welcome to Fall 2026!** Course materials will be posted here as the semester progresses. Start by reading the [syllabus](/2026-InfoVis-CSE/syllabus) and setting up an [Observable](https://observablehq.com) account before the first class on September 4.
...
- **Slides:** [Course Introduction & Syllabus](/2026-InfoVis-CSE/slides/week1-syllabus.html) | [Lab: Observable & Vega-Lite](/2026-InfoVis-CSE/labs/week1-lab.html)
...
- **Readings:** [Card & Mackinlay (1999) - Using Vision to Think](/2026-InfoVis-CSE/refs/Card_Mackinlay_Shneiderman_1999_Using_Vision_to_Think_Chapter1.pdf)

### Week 2 (Sept 11) - Analytical Questions and Data Transformation
- **Slides:** [Analytical Questions and Data Transformation](/2026-InfoVis-CSE/slides/week2-data-transformation.html) | [Lab: Intro to Vega-Lite Data Transformations...](/2026-InfoVis-CSE/labs/week2-lab.html)
- **Topics:** Visual queries, Data types, Transformation operations
- **Lab:** Vega-Lite data transformations, Working with real datasets
- **Assignment:** Exercise 2 - Data questions and transformations (due Sept 17)
- **Readings:** [Shneiderman (1996) - The Eyes Have It](/2026-InfoVis-CSE/refs/Shneiderman_1996_The_Eyes_Have_It.pdf); [Wickham (2014) - Tidy Data](/2026-InfoVis-CSE/refs/Wickham_2014_Tidy_Data.pdf)

### Week 3 (Sept 18) - Fundamental Graphs and Visual Encoding
- **Slides:** [Fundamental Graphs and Visual Encoding](/2026-InfoVis-CSE/slides/week3-fundamental-graphs.html) | [Lab: Fundamental Graphs and Visual Encoding](/2026-InfoVis-CSE/labs/week3-lab.html)
...
- **Slides:** [Visual Perception and D3 Foundations](/2026-InfoVis-CSE/slides/week4-perception.html) | [Lab: First D3 programming session, DOM manipulation, Data binding](/2026-InfoVis-CSE/labs/week4-lab.html)
...
- **Assignment:** Exercise 4 - Perception-based design + D3 implementation (due Oct 1)
...
### Week 5 (Oct 2) - Color Theory and D3 Scales
- **Slides:** [Color Theory and D3 Scales](/2026-InfoVis-CSE/slides/week5-color.html) | [Lab: Color scale exercises, Choropleth maps, Accessibility testing](/2026-InfoVis-CSE/labs/week5-lab.html)
...
- **Assignment:** Exercise 5 - Color scale design and implementation (due Oct 8)
- **Required Readings:**
...
- **Slides:** [Group Projects](/2026-InfoVis-CSE/slides/week6-group-projects.html) | [Lab: Intro to Interactions and Deceptive Visualizations](/2026-InfoVis-CSE/labs/week6-lab.html)
...
- **Action Items:**
  - Form teams by Oct 16 (use Discord #project-teams)
  - Browse datasets for project ideas
  - Exercise 6 - Misleading vs. honest visualization (due Oct 15)
...
- **Slides:** [Interactivity in Information Visualization](/2026-InfoVis-CSE/slides/week7-interaction.html) | [Lab: Building Interactive Visualizations](/2026-InfoVis-CSE/labs/week7-lab.html)
...
- **Required Readings:**
  - [Shneiderman (1996) - The Eyes Have It](/2026-InfoVis-CSE/refs/Shneiderman_1996_The_Eyes_Have_It.pdf)
  - [Heer & Shneiderman (2012) - Interactive Dynamics for Visual Analysis](/2026-InfoVis-CSE/refs/Heer_Shneiderman_2012_Interactive_Dynamics_Visual_Analysis.pdf)
- **Recommended Readings:**
  - [Yi et al. (2007) - Toward a Deeper Understanding of Interaction](/2026-InfoVis-CSE/refs/Yi_2007_Toward_Deeper_Understanding_Interaction.pdf)
  - [Pike et al. (2009) - The Science of Interaction](/2026-InfoVis-CSE/refs/Pike_2009_Science_of_Interaction.pdf)
  - [Zhao et al. (2025) - Libra: Composable Interactions](/2026-InfoVis-CSE/refs/Zhao_2025_Libra_Composable_Interactions.pdf)

### Week 8 (Oct 23) - Foundations of Geovisualization: 2D Maps
- **Slides:** [Foundations of Geovisualization](/2026-InfoVis-CSE/slides/week8-geovis-2d-maps.html) | [Live Demo: Leaflet.js](/2026-InfoVis-CSE/slides/examples/leaflet_example.html) | **Lab:** [Plotting and Troubleshooting GeoJSON with D3](/2026-InfoVis-CSE/labs/week8-lab.html)
...
- **Assignment:** Exercise 8 - Geographic visualization with proper normalization and projection (due Oct 29)
- **Required Readings:**
...
### Week 9 (Oct 30) - Urban Visualization I: Flows, Time & Interactivity **[WIP - DRAFT]**
- **Slides:** [Urban Visualization I](/2026-InfoVis-CSE/slides/week9-urban-flows-interactivity.html) *(draft - figures needed)* | **Lab:** [Building interactive spatio-temporal visualization](/2026-InfoVis-CSE/labs/week9-lab.html)
...
- **Assignment:** Exercise 9 - Urban data exploration and visual queries (due Nov 5)
- **Required Readings:**
...
### Week 10 (Nov 6) - Urban Visualization II: 3D Form, Design & Simulation **[WIP - DRAFT]**
- **Slides:** [Urban Visualization II](/2026-InfoVis-CSE/slides/week10-urban-3d-simulation.html) *(draft - figures needed)* | **Lab:** [3D Visualization: Transformations](/2026-InfoVis-CSE/labs/week10-lab.html)
...
- **Assignment:** Exercise 10 - 3D urban visualization and impact analysis (due Nov 12)
- **Required Readings:**
...
- **Slides:** [Visualizing Time-Oriented Data](/2026-InfoVis-CSE/slides/week11-temporal-data.html) | **Lab:** [Building temporal visualizations, Time series analysis with D3](/2026-InfoVis-CSE/labs/week11-lab.html)
...
- **Assignment:** Exercise 11 - Temporal data visualization (due Nov 19)
- **Required Readings:**
...
- **Slides:** [Clustering and Dimensionality Reduction](/2026-InfoVis-CSE/slides/week12-clustering-dimreduction.html) | **Lab:** [Dimensionality Reduction with D3](/2026-InfoVis-CSE/labs/week12-lab.html)
...
- **Assignment:** Exercise 12 - Clustering and dimensionality reduction visualization (due Dec 3)
- **Required Readings:**
...
### No Class (Nov 27) - Thanksgiving Recess

### Week 13 (Dec 4) - Visualizing Network Data
- **Slides:** [Visualizing Network Data](/2026-InfoVis-CSE/slides/week13-network-data.html)
...
- **Assignment:** Exercise 13 - Network and tree visualization (due Dec 10)
- **Required Readings:**
...
### Week 14 (Dec 11) - Final Project Presentations
...
- Exercise 1: Visualization critique and basic Vega-Lite charts - *Due Sept 10*
- Exercise 2: Data questions and transformations - *Due Sept 17*
- Exercise 3: Chart design and encoding alternatives - *Due Sept 24*
- Exercise 4: Perception-based design + D3 implementation - *Due Oct 1*
- Exercise 5: Color scale design and implementation - *Due Oct 8*
- More exercises TBA
...
- **Milestone 1:** Project Proposal - *Due Oct 19*
- **Milestone 2:** Data Analysis & Sketches - *Due Nov 2*
- **Milestone 3:** First Draft (D3 implementations) - *Due Nov 16*
- **Milestone 4:** Second Draft (Complete article) - *Due Nov 30*
- **Milestone 5:** Final Submission & Presentations - *Due Dec 7* (Presentations Dec 11)
