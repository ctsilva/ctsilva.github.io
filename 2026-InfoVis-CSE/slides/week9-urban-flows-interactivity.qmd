...
subtitle: "Flows, Time & Interactivity (2D + Time) - CS-GY 6313 - Fall 2026"
...
::: {.column width="50%"}
![Static heatmap of 140 million NYC taxi trips](figs/week9/blob.png){fig-align="center" width="100%"}
:::
:::
...
::: {.column width="60%"}
![Hägerstrand's Space-Time Cube showing individual trajectories](figs/week9/space-time-cube.png){fig-align="center" width="100%"}
:::
:::
...
::: {.columns}
::: {.column width="60%"}
![Traditional analysis pipeline](figs/week9/data-analysis-workflow.png){fig-align="center"}
:::
...
![Overview of all data](figs/week9/overview.png){fig-align="center" width="40%"}
...
![Filtered subset of data](figs/week9/filter.png){fig-align="center" width="40%"}
...
![Detailed information display](figs/week9/details.png){fig-align="center" width="40%"}
...
![Taxi activity patterns showing regularity and anomalies](figs/week9/patterns.png){fig-align="center" width="85%"}
...
![TaxiVis interface showing visual query components](figs/week9/interfacewidgets.png){height="500px"}
...
![Full TaxiVis interface showing linked views](figs/week9/interface.png){fig-align="center" width="85%"}
...
![TaxiVis interface with labeled components](figs/week9/interface.png){fig-align="center"}
...
![Side-by-side comparison of Sunday vs Monday airport trips](figs/week9/interface.png){fig-align="center" width="100%"}
...
::: {.column width="50%"}
![Completely cluttered map with all points](figs/week9/lod.png){fig-align="center" width="80%"}
...
::: {.column width="50%"}
![Level of detail rendering in action](figs/week9/lod_zoom.png){fig-align="center" width="80%"}
...
![Pixel-based density heat map](figs/week9/heatmap.png){fig-align="center" width="50%"}
...
![Grid-based aggregation map](figs/week9/neighborhood){fig-align="center" width="50%"}
...
::: {.column width="60%"}
![Sunday vs Monday airport comparison](figs/week9/interface.png){fig-align="center"}
:::
:::
...
::: {.column width="50%"}
![Time series with highlighted time range](figs/week9/regular.png){fig-align="center"}

![Map showing spatial pattern for selected time](figs/week9/slicedist.png){fig-align="center" width="50%"}
:::
:::
...
::: {.column width="60%"}
![Recurrent Selection interface with day-of-week checkboxes](figs/week9/recurrent.png){fig-align="center" width="100%"}
:::
:::
...
![Map showing weekday morning trip patterns](figs/week9/weekday.png){fig-align="center"}
...
![Map showing weekend night trip patterns](figs/week9/weekend.png){fig-align="center"}
...
::: {.column width="50%"}
![Taxi activity comparison across neighborhoods](figs/week9/weekday.png){fig-align="center"}
![Taxi activity comparison across neighborhoods](figs/week9/weekend.png){fig-align="center"}
:::
:::
...
::: {.fragment}
![Tips and fare analysis for Harlem](figs/week9/tips.png){fig-align="center" width="50%"}
![Tips and fare analysis for Harlem](figs/week9/fare.png){fig-align="center" width="40%"}
:::
...
::: {.column width="50%"}
![Transportation hubs comparison](figs/week9/airport-comparison-query.png){fig-align="center"}
:::
:::
...
::: {.column width="50%"}
![Grid of maps showing each Monday in May](figs/week9/mondays.png){fig-align="center"}
:::
:::

## Discovery: Memorial Day Pattern

![Memorial Day vs regular Mondays](figs/week9/mondays.png){fig-align="center" width="80%"}
...
![Daily heat maps showing Hurricane Sandy impact](figs/week9/sandy.png){fig-align="center" width="85%"}
...
![Hurricane Irene impact on taxi trips](figs/week9/irene.png){fig-align="center" width="70%"}
...
4. **Query composition is powerful**
