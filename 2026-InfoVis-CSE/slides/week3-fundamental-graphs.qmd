...
::: {.column width="60%"}
```{=html}
<div id="barchart-demo" style="margin: 0 auto; padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; background-color: #fafafa;"></div>
<script>
{
  const data = [
...
::: {.column width="60%"}
```{=html}
<div id="linechart-demo" style="margin: 0 auto; padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; background-color: #fafafa;"></div>
<script>
{
...
::: {.column width="60%"}
```{=html}
<div id="scatterplot-demo" style="margin: 0 auto; padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; background-color: #fafafa;"></div>
<script>
{
  ...
  const types = ["4-Seam", "Changeup", "Slider"];
...
::: {.column width="60%"}
```{=html}
<div id="matrix-demo" style="margin: 0 auto; padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; background-color: #fafafa;"></div>
<script>
{
  ...
  const cellWidth = 35, cellHeight = 35;
  ...
  svg.append("text")
    .attr("transform", `translate(${margin.left - 40}, ${margin.top + (counts.length * cellHeight) / 2}) rotate(-90)`)
    .attr("text-anchor", "middle")
    .attr("font-size", 11)
    .attr("font-weight", 600)
  ...
  const legendX = margin.left + 20, legendY = height - 50;
...
```{=html}
<div id="marks-demo" style="margin: 20px auto; max-width: 1400px; padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; background-color: #fafafa;"></div>
<script>
{
  ...
  pos.append("g").selectAll("circle").data(data).join("circle")
    .attr("cx", d => len(d.value)).attr("cy", midRow).attr("r", 5);
...
```{=html}
<div id="scales-demo" style="margin: 20px auto; padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; background-color: #fafafa;"></div>
<script>
{
...
```{=html}
<div id="zero-baseline-demo" style="margin: 20px auto; padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; background-color: #fafafa;"></div>
<script>
{
  ...
  function createChart(title, domain) {
    ...
    const margin = {top: 30, right: 20, bottom: 50, left: 180};
...
```{=html}
<div id="break-rules-demo" style="margin: 20px auto; padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; background-color: #fafafa;"></div>
<script>
{
