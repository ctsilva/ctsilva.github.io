...
::: {.column width="60%"}
```{=html}
<div id="barchart-demo" style="margin: 0 auto;"></div>
<script>
{
  const data = [
...
::: {.column width="60%"}
```{=html}
<div id="linechart-demo" style="margin: 0 auto;"></div>
<script>
{
...
::: {.column width="60%"}
```{=html}
<div id="scatterplot-demo" style="margin: 0 auto;"></div>
<script>
{
...
```{=html}
<div id="marks-demo" style="margin: 20px auto; max-width: 1400px;"></div>
...
```{=html}
<div id="zero-baseline-demo" style="margin: 20px auto;"></div>
<script>
{
