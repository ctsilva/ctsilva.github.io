...
::: {.notes}
The key idea of manifold learning methods: preserve local structure. Points that are neighbors in high-dimensional space should remain neighbors in low-dimensional space. Different methods define "neighborhood" and "preserve" differently, but this is the core principle. LLE, Isomap, and t-SNE all try to maintain local neighborhoods while allowing global structure to change.
:::
