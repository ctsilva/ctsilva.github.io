...
::: {.columns}
::: {.column width="50%"}
![](figs/model_assessment_figs/neo_figure1_overview.png){fig-align="center"}
:::

::: {.column width="50%"}
**Key Features:**

- Supports hierarchical and multi-output labels
- Interactive matrix authoring
- Flexible renormalization 
- Derived metrics visualization
- **CHI 2022 Best Paper Award**

**🎥 [Watch Video Demo](https://www.youtube.com/watch?v=LmsJJDHfGlI)**

**[Live Demo & Code](https://github.com/apple/ml-hierarchical-confusion-matrix)**
:::
:::

:::footer
Liu, S., Xiao, D., Liu, J., et al. (2022). [*Neo: Generalizing Confusion Matrix Visualization to Hierarchical and Multi-Output Labels*](../refs/Liu_Bertini_Lins_2021_Neo_Confusion_Matrix.pdf). CHI.
:::
...
- Visual confusion matrix exploration
- Performance metric visualization
- Real-time interaction capabilities

**🎥 [Watch Video Demo](https://youtu.be/yUSwjofGAaQ)**
:::
:::
...
:::footer
Talbot, J., Lee, B., Kapoor, A., & Tan, D. S. (2009). [*EnsembleMatrix: interactive visualization to support machine learning with multiple classifiers*](../refs/Talbot_Lee_Kapoor_Tan_2009_EnsembleMatrix.pdf). CHI.
:::
...
:::footer
Guo, C., Pleiss, G., Sun, Y., & Weinberger, K. Q. (2017). [*On calibration of modern neural networks*](../refs/Guo_Pleiss_Sun_Weinberger_2017_Neural_Network_Calibration.pdf). ICML.
:::
...
:::footer
Xenopoulos, P., Rulff, J., Nonato, L. G., Barr, B., & Silva, C. (2022). [*Calibrate: Interactive analysis of probabilistic model output*](../refs/Xenopoulos_Rulff_Nonato_2022_Calibrate.pdf). IEEE TVCG.
:::
...
:::footer
Vaicenavicius, J., Widmann, D., Andersson, C., et al. (2019). [*Evaluating model calibration in classification*](../refs/Vaicenavicius_Widmann_2019_Evaluating_Model_Calibration.pdf). AISTATS.
:::

## Suggested Calibration Literature

* Niculescu-Mizil, A., & Caruana, R. (2005). [Predicting good probabilities with supervised learning](../refs/Niculescu_Caruana_2005_Predicting_Good_Probabilities.pdf). ICML.
...
* Vaicenavicius, J., Widmann, D., Andersson, C., Lindsten, F., Roll, J., & Schön, T. (2019). [Evaluating model calibration in classification](../refs/Vaicenavicius_Widmann_2019_Evaluating_Model_Calibration.pdf). AISTATS.

## Suggested Calibration Literature

* Kull, M., & Flach, P. (2015). [Novel decompositions of proper scoring rules for classification](../refs/Kull_Flach_2015_Scoring_Rules_Decomposition.pdf). ECML-PKDD.

* [ECML/PKDD 2020 Tutorial: Evaluation metrics and proper scoring rules](../refs/ECML_PKDD_2020_Tutorial_Evaluation_Metrics.pdf)
